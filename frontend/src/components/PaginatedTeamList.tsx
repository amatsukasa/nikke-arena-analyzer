        ...
        {teams.map((team: any, idx: number) => {
          ...
          return (
            <div
              ...
              className={`bg-slate-800/50 hover:bg-slate-700/60 cursor-pointer transition-colors p-4 rounded-xl ring-1 ${isSelected ? "ring-emerald-500 bg-slate-700/80" : "ring-white/5"}`}
            >
              {/* PC表示: 横並び */}
